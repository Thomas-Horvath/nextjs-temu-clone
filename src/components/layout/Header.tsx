    ...
    <header className='w-full sticky top-0 z-50'>
      <div className={`w-full transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-y-0' : '-translate-y-full'}`}>
        ...
        <div className="w-full
                        ...
                        sm:py-4 bg-white/80 shadow-sm border-d border-gray-100
                        backdrop-blur-sm"
        >
          ...
          <div className="flex justify-between items-center container mx-auto px-8">
            ...
            <div className='flex flex-1 justify-end items-center gap-2 sm:gap-4'>
              ...
              <button className="text-gray-700 hover:text-gray-900 relative">
                ...
                <span className='absolute -top-1 -right-1 bg-black text-white text-[10px] sm:text-xs w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full flex justify-center items-center'>0</span>
              </button>
            </div>
